...
namespace AndWebApi.Models
{
    public class AddonCover
    {
        ...
        /// 
              ...
              public bool RepairFiberGlass { get; set; }
        ...
        /// <summary>
        /// get or set is emergency Wide cover.
        /// </summary>
        public bool IsEmergencyWideCover { get; set; }

        /// <summary>
        /// get or set No Of Cliam Taken.
        /// </summary>
        public string NoOfCliamTaken { get; set; }
    }
}