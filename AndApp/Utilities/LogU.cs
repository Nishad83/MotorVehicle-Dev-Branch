...
namespace AndApp.Utilities
{
    public class LogU
    {
        ...
        public static void WritePaymentLog(string message)
        {
            try
            {
                StringBuilder sbText = new StringBuilder();
                ...
                sbText.AppendLine("Message : " + message);
                sbText.AppendLine();
                LogToPaymentFile(string.Empty, sbText.ToString());
            }
            catch (Exception ex)
            {
                LogToFile("LogU >> WriteLog", ex.ToString());
        ...
        public static void WritePaymentLog(Exception ex)
        {
            try
            {
                StackTrace track = new StackTrace(ex, true);
        ...
        private static void LogToPaymentFile(string fileName, string message)
        {
            if (string.IsNullOrEmpty(fileName))
            {
